...
![](figuras/areas/misleading3_pie.png)
...
![](figuras/areas/misleading3_deaths.jpg)
...
<center><img src="figuras/areas/obamaCircles.jpg" width="200px" /></center>
<p class="espacio">
</p>
...
g <- ggplot(data = edo_df, aes(long, lat, group=group)) +
  ...
  coord_map(projection="mercator") +
  theme_nothing()
ggsave(filename = "mexico_mercator.png", plot = g, width = 10, height = 6)
```

<center>![](mexico_mercator.png)</center>
...
g <- ggplot(data = edo_df, aes(long, lat, group=group)) + 
  ...
  coord_map(projection="azequalarea") +
  theme_nothing()
ggsave(filename = "mexico_azimutal.png", plot = g, width = 10, height = 6)
```

<center>![](mexico_azimutal.png)</center>
...
> así como en el libro “R for Data Science” escrito por Hadley Wickham y Garret Grolemund.
...
[16] Hyndman y Fan. Sample quantiles in statistical packages, The American
Statistician, 1996.
...
[19] John W. Tukey y Frederick Mosteller, Data Analysis and Regression,
Addison-Wesley, 1977.

[20] Izenman y Sommer, Philatelic mixtures and multimodal densities, Journal of the
