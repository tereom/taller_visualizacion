...
![](figuras/ch-02-chartjunk-life-expectancy.png)
...
Para cada tipo de gráfico, se les pidió a los sujetos que identificaran el segmento más pequeño de los dos marcados en el gráfico, y luego que "hicieran un juicio visual rápido", estimando qué porcentaje el más pequeño era del más grande. Como se puede ver en la figura, los gráficos probaron los datos codificados de diferentes maneras. Los tipos 1-3 usan codificación de posición a lo largo de una escala común, mientras que los tipos 4 y 5 usan codificación de longitud. El gráfico circular codifica los valores como ángulos, y los gráficos restantes como áreas-circular, rectángulos separados (como en un cartograma) o sub-rectángulos (como en un mapa de árbol).
...
> Las notas de este taller introductorio están basadas en el material de Teresa Ortiz,
> así como en el libro “R for Data Science” escrito por Hadley Wickham.
